...
-(void)viewDidLayoutSubviews{
    ...
    [self.tableViewShare mas_updateConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(self.view.mas_bottom).with.offset(UIApplication.sharedApplication.statusBarOrientation == UIInterfaceOrientationPortrait ? _bottomSafeInset : 240+_bottomSafeInset);
    }];
...
-(void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation
    ...
    [self.tableViewShare mas_updateConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(self.view.mas_bottom).with.offset(toInterfaceOrientation == UIInterfaceOrientationPortrait ? _bottomSafeInset : 240+_bottomSafeInset);
    }];
...
-(void)cancelShareSheet{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.toolbar.frame = CGRectMake(0, self.view.frame.size.height-_bottomSafeInset, self.view.frame.size.width,240+_bottomSafeInset);
        self.tableViewShare.frame = CGRectMake(0, self.view.frame.size.height-_bottomSafeInset, self.view.frame.size.width, 240);
    }];
}
-(void)showShareSheet{
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.toolbar.frame = CGRectMake(0, self.view.frame.size.height-_bottomSafeInset-240, self.view.frame.size.width,240+_bottomSafeInset);
        self.tableViewShare.frame = CGRectMake(0, self.view.frame.size.height-_bottomSafeInset-230, self.view.frame.size.width, 240);
    }];
